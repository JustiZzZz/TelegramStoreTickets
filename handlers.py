...
async def math_payment(callback: CallbackQuery):
    await callback.message.answer(
        text=(
            "Отлично! Вы выбрали тариф <b>«Гайд | Математика»</b>\n\n"
            "<b>К оплате:</b> 29 белорусских рублей\n"
            "<b>Доступ:</b> бессрочный, предоставляется к одному закрытому каналу «Гайд по билетам | Математика»\n\n"
